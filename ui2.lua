...
function Library:CreateWindow(config)
 ...
 = toggleButton
     ...
     toggleCircle.Position = UDim2.new(1, -18, 0.5, -8)
        ...
        function Tab:AddSlider(config)
            config = config or {}
            local sliderName = config.Name or 
 "Slider"
     ...
     dropdownLabel.Text = dropdownName .. ": " .. value
      ...
      local optionButton = Instance.new("TextButton")
                 ...
                 optionButton.Size = UDim2.new(1, 0, 0, 30)
                        ...
                        local 
 optionCorner = Instance.new("UICorner")
                        optionCorner.CornerRadius = UDim.new(0, 6)
                        optionCorner.Parent = optionButton
    ...
    optionButton.MouseButton1Click:Connect(function()
                         ...
                         for _, btn in ipairs(dropdownList:GetChildren()) do
                                if btn:IsA("TextButton") then
                                    CreateTween(btn, 
 {BackgroundColor3 = Theme.Tertiary}, 0.2)
                                end
                            end
 ...
 local multiLabel = Instance.new("TextLabel")
            ...
            multiLabel.Text = multiName .. ": " .. (#multiDefault > 
 0 and table.concat(multiDefault, ", ") or "None")
 ...
 optionLabel.BackgroundTransparency = 1
  ...
  local checkCorner = Instance.new("UICorner")
        ...
        checkmark.TextSize = 12
                ...
                optionButton.Size = UDim2.new(1, 0, 
 1, 0)
                optionButton.Text = ""
                optionButton.AutoButtonColor = false
