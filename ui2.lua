...
function Animations:Create(object, properties, duration, easingStyle, direction)
    ...
    elseif easingStyle == "Back" and direction == "In" then
        local c1 = 1.70158
        local c3 = c1 + 1
        easingFunc = function(t)
    ...
    connection = RunService.Heartbeat:Connect(function()
        ...
        for prop, goal in pairs(properties) do
            local start = startProps[prop]
            local current = lerp(start, goal, eased)
            if object[prop] ~= nil then
                object[prop] = current
            end
            if progress < 1 then
...
function Library:CreateWindow(config)
    ...
    closeBtn.MouseEnter:Connect(function()
        Animations:Create(closeBtn, {BackgroundColor3 = Theme.PrimaryDark}, 0.2)
    end)
    ...
    function Window:CreateTab(config)
        ...
        tabButton.MouseEnter:Connect(function()
            if tabButton.BackgroundColor3 ~= Theme.Primary then
                Animations:Create(tabButton, {BackgroundColor3 = Color3.fromRGB(35, 35, 35)}, 0.2)
            end
        end)

        tabButton.MouseLeave:Connect(function()
            if tabButton.BackgroundColor3 ~= Theme.Primary then
                Animations:Create(tabButton, {BackgroundColor3 = Theme.Tertiary}, 0.2)
            end
        end)
        ...
        function Tab:AddButton(config)
            ...
            button.MouseEnter:Connect(function()
                Animations:Create(button, {BackgroundColor3 = Color3.fromRGB(35, 35, 35)}, 0.2)
            end)

            button.MouseLeave:Connect(function()
                Animations:Create(button, {BackgroundColor3 = Theme.Tertiary}, 0.2)
            end)
        ...
        function Tab:AddToggle(config)
            ...
            toggleFrame.MouseEnter:Connect(function()
                Animations:Create(toggleFrame, {BackgroundColor3 = Color3.fromRGB(35, 35, 35)}, 0.2)
            end)

            toggleFrame.MouseLeave:Connect(function()
                Animations:Create(toggleFrame, {BackgroundColor3 = Theme.Tertiary}, 0.2)
            end)
        ...
        function Tab:AddSlider(config)
            ...
            local function updateSlider(input)
                ...
                Animations:Create(sliderFill, {Size = UDim2.new(pos, 0, 1, 0)}, 0.1)
                Animations:Create(sliderButton, {Position = UDim2.new(pos, -6, 0.5, -6)}, 0.1)
        ...
        function Tab:AddDropdown(config)
                ...
                optionButton.MouseButton1Click:Connect(function()
                    ...
                    for _, btn in ipairs(dropdownList:GetChildren()) do
                        if btn:IsA("TextButton") then
                            Animations:Create(btn, {BackgroundColor3 = Theme.Tertiary}, 0.2)
                        end
                    end

                    Animations:Create(optionButton, {BackgroundColor3 = Theme.Primary}, 0.2)
                    pcall(dropdownCallback, option)
                end)

                optionButton.MouseEnter:Connect(function()
                    if option ~= currentValue then
                        Animations:Create(optionButton, {BackgroundColor3 = Color3.fromRGB(35, 35, 35)}, 0.2)
                    end
                end)

                optionButton.MouseLeave:Connect(function()
                    if option ~= currentValue then
                        Animations:Create(optionButton, {BackgroundColor3 = Theme.Tertiary}, 0.2)
                    end
                end)
            end
            ...
            dropdownButton.MouseButton1Click:Connect(function()
                ...
                if opened then
                    ...
                    Animations:Create(dropdownFrame, {Size = UDim2.new(1, 0, 0, 45 + targetHeight)}, 0.3)
                    Animations:Create(dropdownList, {Size = UDim2.new(1, -10, 0, targetHeight)}, 0.3)
                    Animations:Create(dropdownArrow, {Rotation = 180}, 0.3)
                else
                    Animations:Create(dropdownFrame, {Size = UDim2.new(1, 0, 0, 40)}, 0.3)
                    Animations:Create(dropdownList, {Size = UDim2.new(1, -10, 0, 0)}, 0.3)
                    Animations:Create(dropdownArrow, {Rotation = 0}, 0.3)
                    task.wait(0.3)
                    dropdownList.Visible = false
                end
            end)
        ...
        function Tab:AddMultiDropdown(config)
            ...
            for _, option in ipairs(multiOptions) do
                ...
                optionButton.MouseButton1Click:Connect(function()
                    ...
                    if selectedValues[option] then
                        Animations:Create(checkbox, {BackgroundColor3 = Theme.Primary}, 0.2)
                        checkmark.Text = "✓"
                    else
                        Animations:Create(checkbox, {BackgroundColor3 = Theme.Border}, 0.2)
                        checkmark.Text = ""
                    end
                ...
                optionFrame.MouseEnter:Connect(function()
                    Animations:Create(optionFrame, {BackgroundColor3 = Color3.fromRGB(35, 35, 35)}, 0.2)
                end)

                optionFrame.MouseLeave:Connect(function()
                    Animations:Create(optionFrame, {BackgroundColor3 = Theme.Tertiary}, 0.2)
                end)
            end
            ...
            multiButton.MouseButton1Click:Connect(function()
                ...
                if opened then
                    ...
                    Animations:Create(multiFrame, {Size = UDim2.new(1, 0, 0, 45 + targetHeight)}, 0.3)
                    Animations:Create(multiList, {Size = UDim2.new(1, -10, 0, targetHeight)}, 0.3)
                    Animations:Create(multiArrow, {Rotation = 180}, 0.3)
                else
                    Animations:Create(multiFrame, {Size = UDim2.new(1, 0, 0, 40)}, 0.3)
                    Animations:Create(multiList, {Size = UDim2.new(1, -10, 0, 0)}, 0.3)
                    Animations:Create(multiArrow, {Rotation = 0}, 0.3)
                    task.wait(0.3)
                    multiList.Visible = false
                end
            end)
